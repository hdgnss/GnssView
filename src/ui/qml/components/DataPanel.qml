...
GlassPanel {
    ...
    component ContentFrame: Rectangle {
        ...
        gradient: Gradient {
            ...
            GradientStop { position: 1.0; color: theme.surface0 }
        }
        border.width: 1
    ...
    component MetricCard: Rectangle {
        ...
        border.width: 1
        border.color: emphasize ? Qt.rgba(accentColor.r, accentColor.g, accentColor.b, 0.50) : theme.panelBorder
                ...
                GridLayout {
                    ...
                    Repeater {
                        ...
                        delegate: MetricCard {
                            ...
                            accentColor: theme.metricAccentColor(modelData.semanticRole || "", modelData.value, modelData.valueText, !!modelData.emphasize)
                ...
                ColumnLayout {
                    ...
                    GridLayout {
                        ...
                        MetricCard {
                            ...
                            accentColor: theme.semanticColor("position")
                            emphasize: true
                        }
                        ...
                        MetricCard {
                            ...
                            accentColor: theme.semanticColor("motion")
                        }
                        ...
                        MetricCard {
                            ...
                            accentColor: theme.semanticColor("time")
                        }
                        ...
                        MetricCard {
                            ...
                            accentColor: theme.semanticColor("quality", locationPage.val("quality", Number.NaN))
                        }
                        ...
                        MetricCard {
                            ...
                            accentColor: theme.semanticColor("dop", locationPage.val("hdop", Number.NaN))
                        }
                        ...
                        MetricCard {
                            ...
                            accentColor: theme.satelliteUsageColor(locationPage.val("satellitesUsed", Number.NaN), locationPage.val("satelliteCount", Number.NaN))
                        }
                        ...
                        MetricCard {
                            ...
                            accentColor: theme.semanticColor("age", locationPage.val("age", Number.NaN))
                        }
                        ...
                        MetricCard {
                            ...
                            accentColor: theme.semanticColor("status", locationPage.text("mode", ""))
                        }
                        ...
                        MetricCard {
                            ...
                            accentColor: theme.semanticColor("status", locationPage.text("navigationStatus", ""))
                        }
                        ...
                        MetricCard {
                            ...
                            accentColor: theme.semanticColor("constellation:gps")
                        }
                        ...
                        MetricCard {
                            ...
                            accentColor: theme.semanticColor("constellation:glonass")
                        }
                        ...
                        MetricCard {
                            ...
                            accentColor: theme.semanticColor("constellation:beidou")
                        }
                        ...
                        MetricCard {
                            ...
                            accentColor: theme.semanticColor("constellation:galileo")
                        }
                        ...
                        MetricCard {
                            ...
                            accentColor: theme.semanticColor("neutral")
                        }
                    }
