...
Popup {
    ...
    component ThemeChoice: Rectangle {
        ...
        readonly property bool selected: appSettings ? appSettings.uiTheme === value : value === "dark"

        Layout.fillWidth: true
        Layout.preferredHeight: theme.controlHeight + 6
        radius: theme.controlRadius
        color: selected
            ? Qt.rgba(theme.tabSelectedAccent.r, theme.tabSelectedAccent.g, theme.tabSelectedAccent.b, 0.16)
            : theme.tabButtonBg
        border.width: 1
        border.color: selected
            ? Qt.rgba(theme.tabSelectedAccent.r, theme.tabSelectedAccent.g, theme.tabSelectedAccent.b, 0.74)
        ...
        Rectangle {
            ...
            height: choice.selected ? 3 : (choiceMouse.containsMouse ? 2 : 0)
            radius: theme.tinyRadius
            color: Qt.rgba(theme.tabSelectedAccent.r, theme.tabSelectedAccent.g, theme.tabSelectedAccent.b, choice.selected ? 0.94 : 0.58)
        }
        ...
        MouseArea {
            ...
            anchors.fill: parent
            hoverEnabled: true
            onClicked: if (appSettings) appSettings.uiTheme = choice.value
        }
    }
            ...
            Column {
                ...
                SettingsSection {
                    ...
                    Column {
                        ...
                        HelpLabel {
                            text: "Light keeps the same instrument layout and blue interaction language while using a cold daylight surface for field and lab viewing."
                        }
                    }
                }
